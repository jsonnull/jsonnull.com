...
const openSansRegular = path.resolve(__dirname, "../../../static/fonts/OpenSans-Regular.ttf");
const openSansSemiBold = path.resolve(__dirname, "../../../static/fonts/OpenSans-SemiBold.ttf");
...
const profileImage = promises.readFile(path.resolve(__dirname, "../../../static/img/photo.jpg"));
...
export async function generateOpenGraphImage({ title, slug }: { title?: string; slug: string }) {
